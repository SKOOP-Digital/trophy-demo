...
data management portal info:
https://budibase.skoop.digital/app/trophy#/players
Login credentials:
username: admin1@skoop.digital
password: &4@FS3#5Bp%jQxK%f4

bulk data management via google sheets info:
https://docs.google.com/spreadsheets/d/1JNouOigutATDEwwz9EscxsRIQ0Hi9Zd-bEnDdhWXB1c/edit
login to admin1@skoop.digital google account.

In either method you can modify the data in the 3 tables, Schools, Teams, and Players.

Where Schools contains the school name, primary color, secondary color, accent color, and media url (school image)

Where Teams contains the school name, sport name, year, achievement, team photo url (team image), trophy model url (trophy model (gltf)), and media url (sport image)

Where Players contains the school name, team sport, team year, type (player, d1 athlete, pro athlete), name, media url (player image), number, position, graduation year, sport, college, professional team, points per game, assists, rebounds, passing yards, touchdowns, completion percentage, and other stats

Updating either the google sheet or the portal will automatically update the data in both locations.

You may upload publicly accessible images or videos to the media_url fields in the google sheet, however if you are unsure of how to host the images publically, it is best to use the 'Upload' buttons in the management portal to upload images or videos (and we will automatically host them for you).

Please write a comprehensive wiki page that explains how to use the data management portal and google sheets to update the data, and an overview of how the whole system works, and any other information you think is relevant.
